...
class HomePagingSource(private val apiService: ApiService, private val userId: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, GetPostFollowedData> {
        return try {
            ...
            val response = apiService.getFollowedPosts(idUser = userId, page = nextPageNumber)
